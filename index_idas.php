...
require 'partials/functions_idas.php';
...
?>
    ...
    <main class="container">
            ...
            <div class="col-xs-12 right-align">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <form action="index_idas.php" method="POST" class="filter">
                                        <li>
                                            <input href="index_idas.php" type="submit" name="all" value="Allt">
                                        </li>
                                        <li>
                                            <input href="index_idas.php?cat=watches" type="submit" name="Klockor" value="Klockor">
                                        </li>
                                        <li>
                                            <input href="index_idas.php?cat=sunglasses" type="submit" name="Solglasögon" value="Solglasögon">
                                        </li>
                                        <li>
                                            <input href="index_idas.php?cat=decoration" type="submit" name="Inredning" value="Inredning">
                                        </li>
                                    </form>
                                </ul>
                            </div>
        ...
        <div class="index_login hidden-xs hidden-sm col-md-4">
            <h1 style="text-align:center;">ANVÄNDAREEEE</h1>
            <hr>
        </div>
